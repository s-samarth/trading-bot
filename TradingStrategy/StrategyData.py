...
class TradingStrategyData(BaseModel):
    ...
    """
    trading_symbol: TradingSymbol = Field(..., description="The trading symbol for the stock.")
    exchange: str = Field(default=BaseExchange.NSE, description="The exchange where the stock is traded.")
    ...
    transaction_type: Optional[BaseTransactionType] = Field(..., description="The type of transaction (BUY/SELL).") # Optional