...
class Commands:
    ...
    async def start(self, update: Update, context: ContextTypes):
        await update.message.reply_text(
            "Hello! I am a bot to help you with your trading. How can I help you today?"
        )

    async def help(self, update: Update, context: ContextTypes):
        await update.message.reply_text(
            "I can help you with your trading. Here are some commands you can use:\n\n"
            "/start - Start the bot\n"
            "/help - Get help\n"
    ...
    async def login(self, update: Update, context: CallbackContext):
        ...
        await update.message.reply_text(
            f"Please login to your account by clicking on the link below:\n{auth_url}"
        )
